...
import { Camera, UserPlus, Users, LogOut, User as UserIcon, Settings as SettingsIcon } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
import './Navbar.css';

interface NavbarProps {
  currentPage: 'live' | 'enroll' | 'attendance' | 'settings';
  onNavigate: (page: 'live' | 'enroll' | 'attendance' | 'settings') => void;
}
